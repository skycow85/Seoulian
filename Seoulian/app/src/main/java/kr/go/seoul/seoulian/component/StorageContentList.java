...
public class StorageContentList extends ListView {
    ...
    public StorageContentList(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public void addData(ArrayList<SpotInfo> list){
        mList.addAll(list);
        notifyDataChanged();
    }

    public SpotInfo getData(int position){
    ...
    class TextViewTask extends AsyncTask<Object, Void, String> {
        ...
        protected String doInBackground(Object... params) {
            ...
            switch (type){
                case TITLE:
                    String enName = mList.get(position).getD_CORP_EN_NM();
                    if(enName==null || enName.trim().isEmpty()){
                        String krName = mList.get(position).getD_CORP_KR_NM();
                ...
                case CONTENT:
                    return mList.get(position).getINFO_CORP_EN_INTRO();
            }
    ...
    class ImageViewTask extends AsyncTask<Object, Void, Integer>{
        ...
        protected Integer doInBackground(Object... params) {
            ...
            return StaticData.getIconResForSpot(mList.get(position).getCATEGORY_CD());
